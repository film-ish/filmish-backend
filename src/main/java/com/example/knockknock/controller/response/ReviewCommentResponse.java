...
public class ReviewCommentResponse {
    ...
    public static class Detail{
        ...
        private List<ReviewCommentResponse.Detail> comments;

        public static ReviewCommentResponse.Detail of(ReviewComment reviewComment,
                                                      User writer, MakerMovie makerMovie,
                                                      List<ReviewCommentResponse.Detail> comments){
